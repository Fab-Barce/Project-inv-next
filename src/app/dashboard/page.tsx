...
function Home() {
    return (
        <div className="flex flex-col min-h-screen bg-gray-50">
          ...
          <main className="flex-grow container mx-auto px-4 mt-10 py-8">
            {/* Título principal */}
            <div className="text-center mb-10">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Gestiona tu inventario, vehículos y consulta el historial de movimientos desde este panel central.
              </p>
            </div>
      
            {/* Tarjetas de navegación */}
            <div className="grid grid-cols-1 sm:grid-cols-2 mt-20 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              ...
              <Link href="/dashboard/inventario" className="group">
                <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center justify-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100">
                  ...
                  <p className="text-gray-500 text-center mt-2 text-sm">
                    Gestiona refacciones y recursos disponibles
                  </p>
                </div>
              </Link>
