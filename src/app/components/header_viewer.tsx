...
const Header_viewer = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-blue-700 to-blue-900 text-white shadow-md">
      ...
      >
        <div
          className={`fixed top-0 left-0 h-full w-75 bg-white shadow-lg z-50 flex flex-col transform transition-transform duration-10 ${
          ...
          <nav className="flex-1 p-4 space-y-4 text-sm">
            ...
            <div>
              <button
                ...
                className="w-full text-left text-blue-800 font-semibold flex justify-between items-center uppercase tracking-wide text-xs hover:text-blue-600"
              >
                Inventario
                <ChevronRightIcon
              ...
              >
                <li>
                  <Link href="/dashboard_v2/vista-inventario" className="flex items-center text-blue-700 hover:text-blue-900 hover:underline">
                    <WrenchScrewdriverIcon className="h-4 w-4 mr-2" />
                    Refacciones
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard_v2/vista-inventario/categorias" className="ml-4 flex items-center text-blue-700 hover:text-blue-900 hover:underline">
                    <FolderIcon className="h-4 w-4 mr-2" />
                    Categorías
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard_v2/vista-inventario/proveedores" className="ml-4 flex items-center text-blue-700 hover:text-blue-900 hover:underline">
            ...
            <div>
              ...
              >
                <li>
                  <Link href="/dashboard_v2/vista-vehiculos" className="flex items-center text-blue-700 hover:text-blue-900 hover:underline">
                    <TruckIcon className="h-4 w-4 mr-2" />
                    Vehículos
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard_v2/vista-vehiculos/operadores" className="ml-4 flex items-center text-blue-700 hover:text-blue-900 hover:underline">
            ...
            <div>
              <Link
                href="/dashboard_v2/historial"
                className="flex items-center text-blue-800 font-semibold uppercase tracking-wide text-xs hover:text-blue-600"
              >
