        ...
        >
          ...
          <nav className="flex-1 p-4 space-y-4 text-sm">
            ...
            <div>
              ...
              >
                <li>
                  <Link href="/dashboard/inventario" className="flex items-center text-blue-700 hover:text-blue-900 hover:underline">
                    <WrenchScrewdriverIcon className="h-4 w-4 mr-2" />
                    Refacciones
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard/inventario/categorias" className="ml-4 flex items-center text-blue-700 hover:text-blue-900 hover:underline">
                    <FolderIcon className="h-4 w-4 mr-2" />
                    Categorías
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard/inventario/proveedores" className="ml-4 flex items-center text-blue-700 hover:text-blue-900 hover:underline">
            ...
            <div>
              ...
              >
                <li>
                  <Link href="/dashboard/vehiculos" className="flex items-center text-blue-700 hover:text-blue-900 hover:underline">
                    <TruckIcon className="h-4 w-4 mr-2" />
                    Vehículos
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard/vehiculos/operadores" className="ml-4 flex items-center text-blue-700 hover:text-blue-900 hover:underline">
